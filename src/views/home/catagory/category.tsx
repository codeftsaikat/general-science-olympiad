    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {categories.map((card) => (
          ...
          >
            <Card className="group hover:shadow-xl border-2 border-border hover:border-primary transition-all duration-300">
              <CardContent className="p-6 flex gap-4">
                {/* Icon with gradient background - bigger icon */}
                <div className={`inline-flex p-4 rounded-xl bg-gradient-to-br ${card.color} mb-4 group-hover:scale-110 transition-transform duration-300`}>
                  <div className="text-white text-2xl">
                    {card.icon}
                  </div>
                </div>
